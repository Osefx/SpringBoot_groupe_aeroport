<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <body
    ...
    <div class="container" style="padding-top: 20px;">
      <div class="row">
        ...
        <div class="col">
          ...
          <a class="shadow btn btn-primary" href="form_utilisateur" role="button" aria-controls="offcanvasExample">
            Inscription
          </a>
    ...
    <div class="container" id="contenuPrincipal" style="padding-top: 20px;">
      ...
      <form>
        <input name="aeroportDepart" placeholder="Aeroport de depart" class="shadow"></input>
        <input name="aeroportArrivee" placeholder="Destination" class="shadow"></input>
        <input name="dateDepart"  placeholder="Date de départ" class="shadow" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date"></input>
        <!-- <input name ="dateRetour" placeholder="Date de retour" class="shadow"></input>  Compliqué, à implémenter plus tard-->
      ...
      <div class="container" id="resacontact" style="text-align: center; padding-top: 20px;">
        <a class="shadow btn btn-primary" href="FormClientServlet" role="button" aria-controls="offcanvasExample">
          Mes réservations
        </a>
        <a class="shadow btn btn-primary" href="ContactServlet" role="button" aria-controls="offcanvasExample">
          Contact
        </a>
      </div>
